...
public class ErrorMessageConstants {
  ...
  public static final String ORGANIZATION_DUPLICATE_NAME = "Organization with given name already exists";
  public static final String ORGANIZATION_BY_ID_NOT_FOUND = "Organization with given id not found";
  public static final String ORGANIZATION_INVALID_STATAUS = "Organization isActive value is should be true or false";
  /**
